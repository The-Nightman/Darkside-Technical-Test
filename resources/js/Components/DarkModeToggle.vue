...
<template>
    <button type="button" @click="toggleTheme" aria-label="Toggle Dark Mode"
        class="absolute top-2 right-2 p-0.5 rounded-full text-white border border-gray-300 dark:text-gray-400 hover:bg-gray-400 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:focus:ring-gray-700">
