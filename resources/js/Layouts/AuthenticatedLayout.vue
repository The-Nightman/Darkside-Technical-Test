...
<template>
    <div>
        <div class="min-h-screen bg-gradient-to-tr from-blue-500 to-pink-500 dark:bg-none dark:bg-zinc-800">
                                ...
                                <Dropdown align="right" width="48">
                                    <template #trigger>
                                        <span class="inline-flex rounded-md">
                                            <button type="button"
                                                class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 dark:text-gray-300 bg-white dark:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-200 focus:outline-none focus:outline-gray-500 transition ease-in-out duration-150">
